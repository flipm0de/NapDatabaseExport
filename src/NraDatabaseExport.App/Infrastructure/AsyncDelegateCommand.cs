...
namespace NraDatabaseExport.App.Infrastructure
{
	...
	/// </summary>
	public class AsyncDelegateCommand : AsyncCommandBase, INotifyPropertyChanged
	{
		private readonly Func<object, CancellationToken, Task> _executeAction;
		...
		public override async Task ExecuteAsync(object parameter)
		{
			...
			Task commandResult = _executeAction.Invoke(parameter, _cancelCommand.Token);

			_execution = new NotifyTaskCompletion(commandResult);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AsyncDelegateCommand"/> class with a specified asynchronous command.
		/// </summary>
		...
		public AsyncDelegateCommand(Func<object, CancellationToken, Task> executeAction, Func<object, bool> canExecuteAction = null)
		{
